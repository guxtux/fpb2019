...
%    \draw [fill] (6.85, 4) circle (0.05);
    ...
    \draw [dashed] (0, 0.2) -- (1.5, 0.2);
    \node at (-0.4, 0.2) {$x_{1}$};
    \node at (1, 0.5) {$p_{1}$};

    \draw [fill] (1.5, 0.42) circle (0.05);
    \draw [dashed] (0, 0.42) -- (1.5, 0.42);
    \node at (-0.4, 0.42) {$x_{2}$};
    \node at (1.5, 0.6) {$p_{2}$};

    \draw [dashed] (1.5, 0.2) -- (1.5, 0.6);
    \node at (1.9, 0.4) {$\Delta \: x$};
    ...
    \draw (1, -0.9) -- (1, -0.6);
    \draw (1.5, -0.9) -- (1.5, -0.6);
    \draw [dashed] (1, -0.75) -- (1.5, -0.75) node [below, midway] {$\Delta t$};
